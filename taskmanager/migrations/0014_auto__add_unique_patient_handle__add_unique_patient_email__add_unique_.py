...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Patient', fields ['handle']
        db.create_unique('taskmanager_patient', ['handle'])

        # Adding unique constraint on 'Patient', fields ['email']
        db.create_unique('taskmanager_patient', ['email'])

        # Adding unique constraint on 'Patient', fields ['address']
        db.create_unique('taskmanager_patient', ['address'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Patient', fields ['address']
        db.delete_unique('taskmanager_patient', ['address'])

        # Removing unique constraint on 'Patient', fields ['email']
        db.delete_unique('taskmanager_patient', ['email'])

        # Removing unique constraint on 'Patient', fields ['handle']
        db.delete_unique('taskmanager_patient', ['handle'])
