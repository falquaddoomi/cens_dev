...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('taskmanager_taskinstance', (
            ...
            ('process', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskmanager.Process'])),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100)),
            ('details', self.gf('django.db.models.fields.CharField')(max_length=800, null=True, blank=True)),
            ...
            ('schedule_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('ran_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ...
            ('errored_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('taskmanager', ['TaskInstance'])

        # Adding model 'LogMessage'
        db.create_table('taskmanager_logmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskmanager.TaskInstance'])),
        ...
        db.send_create_signal('taskmanager', ['LogMessage'])

        # Adding field 'TaskTemplate.schedulable'
        db.add_column('taskmanager_tasktemplate', 'schedulable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('taskmanager_taskinstance')

        # Deleting model 'LogMessage'
        db.delete_table('taskmanager_logmessage')

        # Deleting field 'TaskTemplate.schedulable'
        db.delete_column('taskmanager_tasktemplate', 'schedulable')
