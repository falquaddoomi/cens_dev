...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.handle'
        db.alter_column('taskmanager_patient', 'handle', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Patient.handle'
        db.alter_column('taskmanager_patient', 'handle', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
