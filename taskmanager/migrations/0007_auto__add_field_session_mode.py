...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.mode'
        db.add_column('taskmanager_session', 'mode', self.gf('django.db.models.fields.CharField')(default='irc', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Session.mode'
        db.delete_column('taskmanager_session', 'mode')
