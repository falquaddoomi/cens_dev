...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('taskmanager_taskinstance', 'state')

        # Adding field 'TaskInstance.status'
        db.add_column('taskmanager_taskinstance', 'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'TaskInstance.state'
        db.add_column('taskmanager_taskinstance', 'state', self.gf('django.db.models.fields.CharField')(default='pending', max_length=100), keep_default=False)

        # Deleting field 'TaskInstance.status'
        db.delete_column('taskmanager_taskinstance', 'status')
