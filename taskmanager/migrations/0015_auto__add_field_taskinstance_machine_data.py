...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskInstance.machine_data'
        db.add_column('taskmanager_taskinstance', 'machine_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskInstance.machine_data'
        db.delete_column('taskmanager_taskinstance', 'machine_data')
