...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'SerializedTask'
        db.delete_table('taskmanager_serializedtask')


    def backwards(self, orm):
        
        # Adding model 'SerializedTask'
        db.create_table('taskmanager_serializedtask', (
            ('i_initialnode', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('s_session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskmanager.Session'])),
            ('s_app', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('m_retries', self.gf('django.db.models.fields.IntegerField')(max_length=5)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('t_args', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('m_timeout', self.gf('django.db.models.fields.IntegerField')(max_length=8)),
            ('s_tnsid', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('m_sentcount', self.gf('django.db.models.fields.IntegerField')(max_length=5)),
            ('s_last_response', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('s_done', self.gf('django.db.models.fields.BooleanField')(default=False, max_length=50)),
            ('t_pblob', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('s_node', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('taskmanager', ['SerializedTask'])
