...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskEventSchedule'
        db.create_table('taskmanager_taskeventschedule', (
            ('eventschedule_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scheduler.EventSchedule'], unique=True, primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskmanager.TaskInstance'])),
        ))
        db.send_create_signal('taskmanager', ['TaskEventSchedule'])


    def backwards(self, orm):
        
        # Deleting model 'TaskEventSchedule'
        db.delete_table('taskmanager_taskeventschedule')
