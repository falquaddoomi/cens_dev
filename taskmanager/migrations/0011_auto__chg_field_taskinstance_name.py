...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskInstance.name'
        db.alter_column('taskmanager_taskinstance', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'TaskInstance.name'
        db.alter_column('taskmanager_taskinstance', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'taskmanager.taskinstance': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Generic Task'", 'max_length': '80'}),
