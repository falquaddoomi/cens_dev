...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('taskmanager_patient', 'email', self.gf('django.db.models.fields.CharField')(default='default@me\x08mail.com', max_length=200), keep_default=False)

        # Adding field 'Patient.handle'
        db.add_column('taskmanager_patient', 'handle', self.gf('django.db.models.fields.CharField')(default='default_handle', max_length=100), keep_default=False)

        # Adding field 'Patient.contact_pref'
        db.add_column('taskmanager_patient', 'contact_pref', self.gf('django.db.models.fields.CharField')(default='phone', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.email'
        db.delete_column('taskmanager_patient', 'email')

        # Deleting field 'Patient.handle'
        db.delete_column('taskmanager_patient', 'handle')

        # Deleting field 'Patient.contact_pref'
        db.delete_column('taskmanager_patient', 'contact_pref')
    ...
    models = {
        ...
        'taskmanager.patient': {
            ...
            'contact_pref': ('django.db.models.fields.CharField', [], {'default': "'phone'", 'max_length': '50'}),
        ...
        'taskmanager.serializedtask': {
            'Meta': {'object_name': 'SerializedTask'},
            'i_initialnode': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'm_retries': ('django.db.models.fields.IntegerField', [], {'max_length': '5'}),
            'm_sentcount': ('django.db.models.fields.IntegerField', [], {'max_length': '5'}),
            'm_timeout': ('django.db.models.fields.IntegerField', [], {'max_length': '8'}),
            's_app': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            's_done': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'max_length': '50'}),
            's_last_response': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            's_node': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            's_session': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['taskmanager.Session']"}),
            's_tnsid': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            't_args': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            't_pblob': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        },
        'taskmanager.service': {
