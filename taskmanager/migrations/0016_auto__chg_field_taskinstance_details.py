...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskInstance.details'
        db.alter_column('taskmanager_taskinstance', 'details', self.gf('django.db.models.fields.CharField')(max_length=1800, null=True))


    def backwards(self, orm):
        
        # Changing field 'TaskInstance.details'
        db.alter_column('taskmanager_taskinstance', 'details', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))
