...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field goals on 'ASAPParticipant'
        db.create_table('ASAP_asapparticipant_goals', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('asapparticipant', models.ForeignKey(orm['ASAP.asapparticipant'], null=False)),
            ('asapgoal', models.ForeignKey(orm['ASAP.asapgoal'], null=False))
        ))
        db.create_unique('ASAP_asapparticipant_goals', ['asapparticipant_id', 'asapgoal_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field goals on 'ASAPParticipant'
        db.delete_table('ASAP_asapparticipant_goals')
