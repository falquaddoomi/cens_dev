...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ASAP_resource', (
            ...
            ('for_over18', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('for_under18', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('ASAP', ['Resource'])

        # Adding M2M table for field diagnoses on 'Resource'
        db.create_table('ASAP_resource_diagnoses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resource', models.ForeignKey(orm['ASAP.resource'], null=False)),
            ('diagnosis', models.ForeignKey(orm['ASAP.diagnosis'], null=False))
        ))
        db.create_unique('ASAP_resource_diagnoses', ['resource_id', 'diagnosis_id'])


    def backwards(self, orm):
        
        # Deleting model 'Resource'
        db.delete_table('ASAP_resource')

        # Removing M2M table for field diagnoses on 'Resource'
        db.delete_table('ASAP_resource_diagnoses')
